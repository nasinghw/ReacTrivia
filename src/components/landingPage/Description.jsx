...
const Description = () => {
  return (
    <div>
      <p className="text-base md:text-md lg:text-lg xl:text-1xl text-center mt-10 p-3 mx-5">
        ...
        out with friends to see who can top the leaderboard with their
        highscore, and become the ultimate quiz master.
        <br />
        <br />
